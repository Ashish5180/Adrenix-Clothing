...
import { FaTag, FaRuler, FaPalette, FaDollarSign } from 'react-icons/fa';
      ...
      <div className="flex flex-wrap justify-center gap-8">
        {products.map((product) => (
          <motion.div
            ...
            className="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl w-full max-w-md"
          >
            <div className="relative">
              ...
              <motion.div
                ...
                transition={{ duration: 0.3 }}
                className="absolute inset-0 bg-black bg-opacity-30 flex items-center justify-center text-white text-lg font-semibold"
              >
                View Product
              </motion.div>
            </div>
